...
rect( x , y, 20, h , "fill" )
rect( x, y, w , 20 , "fill" )
rect( x + w - 20, y, 20, h, "fill" )
}

table( 500 ,500, 300, 100, "orange")
balloon(600,300,"purple", 200)
table( 150 ,560, 300, 50, "red")
balloon(300,460,"yellow", 100)
table( 150 , 360, 200, 50, "black")
balloon(250,20,"green", 340)